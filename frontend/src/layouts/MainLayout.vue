...
$q.notify({
  ...
  message: 'Demonstração IanoWhatsapp',
  caption: 'Acesse a versão completa no GitHub.',
  timeout: 0, // só fecha manualmente
  actions: [
    {
      label: 'Abrir GitHub',
      icon: 'mdi-github',
      color: 'green-3',
      handler: () => window.open('https://github.com/samuelvictorol/iano-whatsapp/', '_blank')
    },
    {
      label: 'Fechar',
      color: 'red-5',
